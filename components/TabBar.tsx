  ...
  return (
    <SafeAreaView>
      <View className="flex-row items-center justify-center w-full gap-5 my-2">
        <View
          className={`flex-row justify-centerc items-center bg-card border-border border rounded-full p-2`}
        >
        ...
        <Pressable
          className="bg-card border-border border rounded-full w-16 h-16 items-center justify-center"
